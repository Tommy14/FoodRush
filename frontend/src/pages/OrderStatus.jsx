          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {orders.map((order) => {
              ...
              return (
                <div
                  key={order._id}
                  className="bg-white rounded-xl shadow-lg p-6 border border-gray-200 hover:shadow-xl transition min-w-[320px]"
                >
                {/* Step Labels */}
                  <div className="mb-4">
                    <div className="flex justify-between text-[10px] font-medium mb-2 text-center gap-x-2 flex-wrap">
